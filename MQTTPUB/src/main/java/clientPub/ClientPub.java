...
public class ClientPub {
    ...
    private ClientPub(String clientId, Conection conection, Comunication comunication) {
        this.clientId = clientId;
        this.conection = conection;
        this.comunication = comunication;
    ...
    public static class ClientSubBuilder{
        ...
        public ClientPub createClientPub(){
            return new ClientPub(clientId,conection,comunication);
